...
This is the public documentation index for ADT.ai `1.4.0`.
...
| [patch](patch.md) | Build and deploy release patches from committed repo changes, or upload static files as you save them. |
...
| [patch / static files as you save them](patch_upload.md) | Uploading static files into the application or the workspace, every save while `-upload` watches. |
| [rebuild](rebuild.md) | Refresh the local stores: the Git commit cache, the object dependencies and, on request, an APEX application's dependencies and page links; inspect and switch branches. |
...
| [search](search.md) | Search the rebuild commit cache and restore historical file versions, or ask the object dependency graph and APEX page links. |
