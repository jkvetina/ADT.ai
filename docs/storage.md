...
| ---------------------------------------------------------------------------------- | --------------------------------- | ------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [commits](storage_commits.md)                                                      | `config/commits/<branch>.db`      | [rebuild](rebuild.md)           | [search_repo](search_repo.md), [calendar](calendar.md), [patch](patch.md)     | Delete the file and run `rebuild`; everything in it comes from git.                  |
