...
| ---------------------------------------------------------------------------------- | --------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [commits](storage_commits.md)                                                      | `config/commits/<branch>.db`      | [rebuild](rebuild.md)                                               | [search](search.md), [calendar](calendar.md), [patch](patch.md)           | Delete the file and run `rebuild`; everything in it comes from git.                  |
| [apex](storage_apex.md)                                                            | `config/internal/apex.db`         | [export_apex](export_apex.md)                                       | [export_apex](export_apex.md), [validate](validate.md), [patch](patch.md) | Delete the file; the next export refills it, and the timers start from nothing.      |
| [dependencies](storage_dependencies.md), [APEX half](storage_dependencies_apex.md) | `config/internal/dependencies.db` | [rebuild](rebuild.md), [export_db](export_db.md), [patch](patch.md) | [search](search.md), [recompile](recompile.md), [patch](patch.md)         | Any refresh; a file older than the opener can lift is wiped by a refresh.            |
| [flow](storage_flow.md)                                                            | `config/internal/flow.db`         | [rebuild](rebuild.md)                                               | [search](search.md)                                                       | `rebuild -app` per application; the store is a cache of the live dictionary.         |
