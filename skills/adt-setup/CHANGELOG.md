...
- `doctor -init` notes that every scaffolded file follows `file_crlf`, and that `-init -sync` rewrites a scaffolded file differing only in line endings (ADT.ai `#944`).
