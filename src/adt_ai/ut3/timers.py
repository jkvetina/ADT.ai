"""What the previous `ut3` run cost, kept in `config/internal/ut3_timers.yaml`.
...
TIMERS_FILENAME = "ut3_timers.yaml"
...
def timers_path(root: Path) -> Path:
    """`<root>/config/internal/ut3_timers.yaml`, resolved like every cache.
