...
# Whole navigation flow map for one application: the 12 link-source views,
# UNION ALL'd, with the f?p app/page token regex and the flag CASE. The two
# `define`s become the :app_id bind;
